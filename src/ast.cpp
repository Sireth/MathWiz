...
String::String(const std::string &value) : Ast(AstType::string) {
	this->value = value;
}
...
Boolean::Boolean(bool value) : Ast(AstType::boolean) {
	this->value = value;
}


BinaryOperator::BinaryOperator(std::shared_ptr<Ast> left, std::shared_ptr<Ast> right, Type op) : Ast(AstType::binary_operator){
	this->left = std::move(left);
	this->right = std::move(right);
	this->op = op;
}

AddOperator::AddOperator(std::shared_ptr<Ast> left, std::shared_ptr<Ast> right) : BinaryOperator(std::move(left), std::move(right), add) {}

SubtractOperator::SubtractOperator(std::shared_ptr<Ast> left, std::shared_ptr<Ast> right) : BinaryOperator(std::move(left), std::move(right), sub) {}

MultiplyOperator::MultiplyOperator(std::shared_ptr<Ast> left, std::shared_ptr<Ast> right) : BinaryOperator(std::move(left), std::move(right), mul) {}

DivideOperator::DivideOperator(std::shared_ptr<Ast> left, std::shared_ptr<Ast> right) : BinaryOperator(std::move(left), std::move(right), div) {}

GreaterOperator::GreaterOperator(std::shared_ptr<Ast> left, std::shared_ptr<Ast> right) : BinaryOperator(std::move(left), std::move(right), gr) {}

LessOperator::LessOperator(std::shared_ptr<Ast> left, std::shared_ptr<Ast> right) : BinaryOperator(std::move(left), std::move(right), le) {}

EqualOperator::EqualOperator(std::shared_ptr<Ast> left, std::shared_ptr<Ast> right) : BinaryOperator(std::move(left), std::move(right), eq) {}

NotEqualOperator::NotEqualOperator(std::shared_ptr<Ast> left, std::shared_ptr<Ast> right) : BinaryOperator(std::move(left), std::move(right), n_eq) {}

GreaterEqualOperator::GreaterEqualOperator(std::shared_ptr<Ast> left, std::shared_ptr<Ast> right) : BinaryOperator(std::move(left), std::move(right), gr_eq) {}

LessEqualOperator::LessEqualOperator(std::shared_ptr<Ast> left, std::shared_ptr<Ast> right) : BinaryOperator(std::move(left), std::move(right), le_eq) {}

InOperator::InOperator(std::shared_ptr<Ast> left, std::shared_ptr<Ast> right) :	BinaryOperator(std::move(left), std::move(right), in) {}

AndOperator::AndOperator(std::shared_ptr<Ast> left, std::shared_ptr<Ast> right) : BinaryOperator(std::move(left), std::move(right), _and) {}

OrOperator::OrOperator(std::shared_ptr<Ast> left, std::shared_ptr<Ast> right) : BinaryOperator(std::move(left), std::move(right), _or) {}
